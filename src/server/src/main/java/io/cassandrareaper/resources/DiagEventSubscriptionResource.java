...
public final class DiagEventSubscriptionResource {
  ...
  public Response getEventSubscription(
    ...
    DiagEventSubscription subscription = diagEventService.getEventSubscription(id);
    if (null == subscription) { //@fixme change to catch
  ...
  public Response deleteEventSubscription(
    ...
    if (diagEventService.deleteEventSubscription(id)) {
      return Response.ok().entity(subscription).build();
    } else {
